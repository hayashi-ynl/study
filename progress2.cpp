// progress2.cpp : コンソール アプリケーションのエントリ ポイントを定義します。
// 2017-05-18 20:30
...
char program[] = "C:\\AMADA\\UIFSYS\\Bin\\UIFRSO.exe";	//外部実行ファイルの絶対パス

char masterPass[_MAX_PATH] = "M:\\Ｌ・進捗フォルダ\\";	//生データディレクトリ
char masterCpPass[_MAX_PATH] = "C:\\iot_work\\JAMB-Line\\Progress\\";	//処理結果ディレクトリ
